...
test_data_aaa_patch = [
    ...
    },
    {
        ...
        "origin_json": {"AAA": {"authorization": {"login": ""}}},
        "target_json": {"AAA": {"authorization": {"login": "tacacs+"}}},
    },
    {
    ...
    },
    {
        ...
        "operations": [{"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/TACPLUS"}],
        "origin_json": {
            "TACPLUS": {
                "global": {
                    "auth_type": "login",
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/TACPLUS_SERVER"}
        ],
        "origin_json": {
            "TACPLUS_SERVER": {
                "100.127.20.21": {
...
test_data_bgp_prefix_patch = [
    ...
    },
    {
        ...
        "target_json": {
            "BGP_ALLOWED_PREFIXES": {
                "DEPLOYMENT_ID|0|1010:1010": {
                    "prefixes_v4": ["10.30.0.0/16"],
                    "prefixes_v6": ["fc01:30::/64"],
                }
            }
        },
    },
    {
        ...
        "target_json": {
            "BGP_ALLOWED_PREFIXES": {
                "DEPLOYMENT_ID|0|1010:1010": {
                    "prefixes_v4": ["10.30.0.0/16", "10.20.0.0/16"],
                    "prefixes_v6": ["fc01:30::/64", "fc01:20::/64"],
                }
            }
        },
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/BGP_ALLOWED_PREFIXES"}
        ],
        "origin_json": {
            "BGP_ALLOWED_PREFIXES": {
                "DEPLOYMENT_ID|0|1010:1010": {
...
test_data_bgp_sentinel_patch = [
        ...
        "operations": [
            {
                ...
                "value": {
                    ...
                    "BGPSentinelV6": {
                        "ip_range": ["2603:10a1:30a:8000::/59"],
                        "name": "BGPSentinelV6",
    ...
    },
    {
        ...
        "target_json": {
            "BGP_SENTINELS": {
                "BGPSentinel": {
                    "ip_range": ["10.10.20.0/24", "10.255.0.0/25"],
                    "name": "BGPSentinel",
                    "src_address": "10.5.5.5",
                },
                "BGPSentinelV6": {
                    "ip_range": ["2603:10a1:30a:8000::/59", "cc98:2008:2012:2022::/64"],
                    "name": "BGPSentinelV6",
                    "src_address": "fc00:fc00:0:10::5",
                },
            }
...
test_data_bgp_speaker_patch = [
        ...
        "operations": [
            {
                ...
                "value": {
                    ...
                    "BGPSLBPassiveV6": {
                        "ip_range": ["cc98:2008:2012:2022::/64"],
    ...
    },
    {
        ...
        "target_json": {
            "BGP_PEER_RANGE": {
                "BGPSLBPassive": {
                    "ip_range": ["10.255.0.0/25", "20.255.0.0/25"],
                    "name": "BGPSLBPassive",
                    "src_address": "10.1.0.33",
                },
                "BGPSLBPassiveV6": {
...
test_data_cacl_patch = [
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/ACL_TABLE/SSH_ONLY"}
        ],
        "origin_json": {
            "ACL_TABLE": {
                "SNMP_ACL": {"policy_desc": "SNMP_ACL"},
                "SSH_ONLY": {"policy_desc": "SSH_ONLY"},
                "NTP_ACL": {"policy_desc": "NTP_ACL"},
            }
        },
        "target_json": {
            "ACL_TABLE": {
...
test_data_dhcp_relay_patch = [
    {
        ...
        "origin_json": {"VLAN": {"Vlan100": {"dhcp_servers": ["192.1.0.1"]}}},
        "target_json": {
            "VLAN": {"Vlan100": {"dhcp_servers": ["192.0.100.1", "192.1.0.1"]}}
        },
    },
    {
...
test_data_eth_interface_patch = [
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"lanes": "1,2,3,4"}}},
        "target_json": {"PORT": {"Ethernet0": {"lanes": "1,2,3,5"}}},
    },
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"mtu": "1500"}}},
        "target_json": {"PORT": {"Ethernet0": {"mtu": "1514"}}},
    },
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"pfc_asym": "on"}}},
        "target_json": {"PORT": {"Ethernet0": {"pfc_asym": "off"}}},
    },
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"fec": "fc"}}},
        "target_json": {"PORT": {"Ethernet0": {"fec": "rs"}}},
    },
    {
        ...
        "origin_json": {
            "PORT": {"Ethernet0": {"index": "1"}, "Ethernet4": {"index": "2"}}
        },
        "target_json": {
            "PORT": {"Ethernet0": {"index": "2"}, "Ethernet4": {"index": "1"}}
        },
    },
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"speed": "1000"}}},
        "target_json": {"PORT": {"Ethernet0": {"speed": "2000"}}},
    },
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"description": ""}}},
        "target_json": {"PORT": {"Ethernet0": {"description": "Updated description"}}},
    },
    {
        ...
        "origin_json": {"PORT": {"Ethernet0": {"admin_status": "up"}}},
        "target_json": {"PORT": {"Ethernet0": {"admin_status": "down"}}},
    },
]
...
test_data_incremental_qos_patch = [
    {
        ...
        "origin_json": {
            "BUFFER_POOL": {"ingress_lossless_pool": {}, "egress_lossy_pool": {}}
        },
        "target_json": {
            "BUFFER_POOL": {
                "ingress_lossless_pool": {"xoff": "2000", "size": "5000"},
                "egress_lossy_pool": {"size": "6000"},
            }
        },
    },
    {
        ...
        "target_json": {
            "BUFFER_POOL": {
                "ingress_lossless_pool": {"xoff": "2001", "size": "5001"},
                "egress_lossy_pool": {"size": "6001"},
            }
        },
    },
    {
...
test_data_ipv6_patch = [
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/BGP_NEIGHBOR/fc00::7a"}
        ],
        "origin_json": {
            "BGP_NEIGHBOR": {
                "fc00::7a": {
...
test_data_k8s_config_patch = [
    {
        ...
        "origin_json": {"KUBERNETES_MASTER": {}},
        "target_json": {"KUBERNETES_MASTER": {"SERVER": {}}},
    },
    {
        ...
        "origin_json": {"KUBERNETES_MASTER": {"SERVER": {"disable": "true", "ip": ""}}},
        "target_json": {
            "KUBERNETES_MASTER": {"SERVER": {"disable": "false", "ip": "k8svip.ap.gbl"}}
        },
    },
    {
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/KUBERNETES_MASTER"}
        ],
        "origin_json": {"KUBERNETES_MASTER": {"SERVER": {"disable": "true", "ip": ""}}},
        "target_json": {},
    },
...
test_data_lo_interface_patch = [
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": r"/sonic-db:CONFIG_DB/localhost/LOOPBACK_INTERFACE"}
        ],
        "origin_json": {
            "LOOPBACK_INTERFACE": {
                "Loopback0": {},
    ...
    },
    {
        ...
        "origin_json": {
            "LOOPBACK_INTERFACE": {
                "Loopback0": {"vrf_name": "Vrf_01"},
            }
        },
        "target_json": {
            "LOOPBACK_INTERFACE": {
                "Loopback0": {"vrf_name": "Vrf_02"},
            }
        },
    },
]
...
test_data_ntp_patch = [
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/NTP_SERVER/10.0.0.1"},
            {
                "op": "update",
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/NTP_SERVER"}
        ],
        "origin_json": {
            "NTP_SERVER": {
                "10.0.0.1": {
...
test_data_pfcwd_interval_patch = [
    {
        ...
        "origin_json": {"PFC_WD": {"GLOBAL": {}}},
        "target_json": {"PFC_WD": {"GLOBAL": {"POLL_INTERVAL": "800"}}},
    }
]
...
test_data_pfcwd_status_patch = [
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/PFC_WD/Ethernet0"},
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/PFC_WD/Ethernet4"},
        ],
        "origin_json": {
            "PFC_WD": {
                "Ethernet0": {
...
test_data_pg_headroom_patch = [
    {
        ...
        "origin_json": {
            "BUFFER_PROFILE": {
                "pg_lossless_100000_300m_profile": {"xoff": "160000"},
            }
        },
        "target_json": {
            "BUFFER_PROFILE": {
                "pg_lossless_100000_300m_profile": {"xoff": "160001"},
            }
        },
    }
]
        ...
        "operations": [
            {
                ...
                "value": {"10.0.0.5": {}, "cc98:2008::1": {}},
            }
        ],
        "origin_json": {"SYSLOG_SERVER": {}},
        "target_json": {"SYSLOG_SERVER": {"10.0.0.5": {}, "cc98:2008::1": {}}},
    },
    {
        ...
        "origin_json": {"SYSLOG_SERVER": {"10.0.0.5": {}, "cc98:2008::1": {}}},
        "target_json": {"SYSLOG_SERVER": {"10.0.0.6": {}, "cc98:2008::2": {}}},
    },
    {
...
test_data_vlan_interface_patch = [
    {
        ...
        "origin_json": {"VLAN_INTERFACE": {}, "VLAN": {}},
        "target_json": {
            "VLAN_INTERFACE": {
                "Vlan1001": {},
    ...
    },
    {
        ...
        "operations": [
            {"op": "del", "path": "/sonic-db:CONFIG_DB/localhost/VLAN_INTERFACE"}
        ],
        "origin_json": {
            "VLAN_INTERFACE": {
                "Vlan1001": {},
        ...
        "target_json": {"VLAN": {"Vlan1001": {"vlanid": "1001"}}},
    },
    {
        ...
        "origin_json": {"VLAN": {"Vlan1001": {"vlanid": "1001"}}},
        "target_json": {
            "VLAN": {
                "Vlan1001": {
                    "vlanid": "1001",
...
class TestGNMIConfigDbPatch:
    ...
    def common_test_handler(self, test_data):
        ...
        assert len(diff.patch) == 0, "%s failed, generated json: %s" % (
            test_data["test_name"],
            str(result),
        )
