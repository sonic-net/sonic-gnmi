...
func TestInstallOS_Success(t *testing.T) {
	req := "stable"
...
func TestInstallOS_Unimplemented(t *testing.T) {
	req := "stable"
...
func TestInstallDbusClientError(t *testing.T) {
	req := "stable"

	patch := gomonkey.ApplyFunc(DbusApi, func(busName, busPath, intName string, timeout int, req interface{}) (interface{}, error) {
