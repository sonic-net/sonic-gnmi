...
func TestCredentialzDbusMethods(t *testing.T) {
	...
	t.Run("ConsoleSet", func(t *testing.T) {
		...
		// Patch DbusApi to verify arguments
		patches := gomonkey.ApplyFunc(DbusApi, func(bus, path, intf string, timeout int, args ...interface{}) (interface{}, error) {
...
func TestConsoleCheckpoint(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			// Patch DbusApi to verify the internal logic of ConsoleCheckpoint
			patches := gomonkey.ApplyFunc(DbusApi, func(bus, path, intf string, timeout int, args ...interface{}) (interface{}, error) {
				assert.Equal(t, "org.SONiC.HostService.gnsi_console", bus)
